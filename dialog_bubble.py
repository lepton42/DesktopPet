...
QUOTES = {
    ...
    "cheer_zootopia": [
        "嘿！今天这身狐尼克同款粉衬衫够不够靓？🦊",
        "口袋里这只小狐狸非要探出头看看你在写什么代码~ ✨",
        "来大口吸一口冰镇特饮！烦恼全消~ 🍹",
        "聪明的狐狸从不死磕 Bug，站起来伸个懒腰再战！😎",
        "这就是所谓的‘狐式优雅’！帅气值直接拉满 ✌️",
        "在动物城写代码，速度也是肉眼可见的飞快！💨",
        "生活就像粉色衬衫，就要穿出最绚烂的色彩！🌺",
    ],
    "cheer_camera_toast": [
        "咔嚓！📸 镜头捕捉到一个正在闪闪发光的大神！",
        "来！隔空碰个杯——Cheers！🥂 敬每一个跑通的算法！",
        "看镜头~ 三、二、一，笑一个！给今天的努力留个纪念 ✨",
        "光影正好，代码写得这么漂亮，不抓拍一张可惜了！📷",
        "敬科研，敬生活，也敬一直在身旁默默陪伴的彼此！💖",
        "按下快门，所有 Bug 全部原地蒸发！🪄",
        "辛苦啦！无论多难的关卡，有我陪你一起通关！💪",
    ],
    "cheer_boy": [
        "哟！写代码辛苦啦，给你比个耶 ✌️！",
        "今天这套粉色花衬衫够不够帅气？😎",
